...
const Navbar = () => {
  return (
    <nav className="bg-[#F9EAE1] py-5 px-6 flex justify-between items-center">
      {/* Logo */}
      <div className="text-4xl font-bold text-[#2F2F2F]" style={{ fontFamily: "VT323" }}>
        Bakdient
      </div>

      {/* Navigation Links */}
      <div className="flex space-x-6" style={{ fontFamily: "Montserrat Alternates" }}>
        <Link to="/" className="flex items-center text-[#2F2F2F] hover:text-gray-600 transition mx-3">
          <Home className="w-5 h-5 mr-1" /> Home
        </Link>
        <Link to="/recipes" className="flex items-center text-[#2F2F2F] hover:text-gray-600 transition mx-3">
          <BookOpen className="w-5 h-5 mr-1" /> Recipes
        </Link>
        <Link to="/features" className="flex items-center text-[#2F2F2F] hover:text-gray-600 transition mx-3">
          <List className="w-5 h-5 mr-1" /> Features
        </Link>
      </div>

      {/* Sign In / Sign Out Buttons */}
      <div className="flex space-x-3" style={{ fontFamily: "Montserrat Alternates" }}>
